...
export async function GET(
  ...
  try {
    ...
    const referrersRes = await installationOctokit.request("GET /repos/{owner}/{repo}/traffic/popular/referrers", {
      owner,
      repo,
    });
    ...
    return NextResponse.json({ error: error.message || "Failed to fetch referrers data" }, { status: 500 });
  }
}
