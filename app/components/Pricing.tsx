    ...
    <div className="py-16 md:py-24 bg-background tracking-tight">
      <div className="w-full max-w-sm mx-auto px-5 flex flex-col items-center gap-6">
        ...
        <p className="text-[#666] text-center tracking-tight text-lg/6 w-full max-w-md font-medium">
          Our pricing is simple and transparent. No hidden fees, no credit card
          required.
        </p>
        ...
        <div className="flex flex-col items-center gap-2 mt-4">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-4xl text-[#999] line-through font-medium">
              $9
            </span>
        ...
        <div className="w-full flex flex-col gap-1 mt-6">
          {features.map((feature) => (
            ...
            >
              <span className="text-[#181925] text-sm font-medium">
                {feature.label}
              </span>
              <span className="text-[#666] text-sm font-medium">
                {feature.value}
        ...
        <div className="w-full flex flex-col items-center gap-2 mt-2">
          <button className="w-full bg-[#38b000] px-5 h-11 gap-2 hover:opacity-90 transition-colors duration-200 text-white items-center justify-center cursor-pointer rounded-full font-medium">
