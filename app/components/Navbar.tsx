export default function Navbar() {
  return (
    <header className="dark fixed top-8 left-1/2 -translate-x-1/2 z-[99] w-[420px] bg-[#1a1a1a] backdrop-blur-lg rounded-[24px] overflow-hidden shadow-xl hidden md:block">
      <div>
