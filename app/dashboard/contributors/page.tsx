  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 tracking-tight">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-[#666] font-normal">See who's contributing to your project.</p>
      </div>
        ...
        <div className="flex-1 space-y-4">
          <div className="bg-white rounded-2xl shadow-sm border border-[#f7f7f7] overflow-hidden">
            <div className="px-4 py-4">
              ...
              <p className="text-sm text-[#999] mb-4">People who have contributed to your project.</p>
              <div className="h-48 bg-[#fafafa] rounded-xl flex items-center justify-center">
                <span className="text-[#999] text-sm">Contributors list coming soon</span>
              </div>
            </div>
          </div>
        </div>
